package com.hims.product.service.services.impl;

import com.hims.product.service.entities.Stock;
import com.hims.product.service.entities.StockStatus;
import com.hims.product.service.payloads.StockInfo;
import com.hims.product.service.repositories.StockRepository;
import com.hims.product.service.services.ProductService;
...
public class ProductServiceImpl implements ProductService
{
    ...
    public void publishProductAvailability(Stock stock)
    {
        ...
        {
             kafkaTemplate.send("stock-topic", new StockInfo(stock.getProduct().getProductId(), true));
